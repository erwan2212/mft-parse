...
you can download from here system.data.sqlite for powershell (recommended : .net 4.6) : [https://system.data.sqlite.org/index.html/doc/trunk/www/downloads-unsup.wiki](https://www.sqlite.org/download.html)<br>
<br>
